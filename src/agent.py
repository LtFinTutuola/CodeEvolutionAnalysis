...
from src.nodes.node_5_aggregator import node_5_aggregator
...
workflow.add_node("aggregator", node_5_aggregator)
workflow.add_node("exporter", node_6_exporter)

# Define linear edges
workflow.add_edge(START, "config_manager")
workflow.add_edge("config_manager", "git_extractor")
workflow.add_edge("git_extractor", "roslyn_parser")
workflow.add_edge("roslyn_parser", "semantic_filter")
workflow.add_edge("semantic_filter", "aggregator")
workflow.add_edge("aggregator", "exporter")
